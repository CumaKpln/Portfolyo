        ...
        <div className="flex flex-col items-center justify-center space-y-6">
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              className="p-4 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
            />
          </div>
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              className="p-4 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div className="flex flex-col w-full">
          ...
          <div className="pt-5 transitions-all transform hover:scale-105  self-start">
            <a
              href="#"
